...
export default function NewPlantPage() {
  ...
  const onSubmit = async (data: PlantFormData) => {
    try {
      ...
      // Generate a temporary ID (will be replaced by Firebase)
      ...
      // Save to Firebase
      const savedPlant = await FirebasePlantRepository.save(newPlant);
      
      // Navigate to the plant detail page
      router.push(`/plants/${savedPlant.id}`);
    } catch (err) {
      ...
      <div className="min-h-screen p-6 sm:p-8">
        ...
        >
          ...
          >
            ...
            <span className="text-canopy-green font-medium">Add New Plant</span>
          </motion.div>
